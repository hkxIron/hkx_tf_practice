...
# 连线棋
# 这里给出一个简单的强化学习例子Tic-Tac-Toe。这是一个简单的游戏，在一个3x3的九宫格里，
# 两个人轮流下，直到有个人的棋子满足三个一横一竖或者一斜，赢得比赛游戏结束，或者九宫格填满也没有人赢，则和棋。
...
class State:
    ...
    # check whether a player has won the game, or it's a tie(和棋)
    def is_end(self):
...
class Player:
    ...
    def set_symbol(self, symbol):
        ...
        for hash_val in all_states.keys():
            ...
            if is_end:
                if state.winner == self.symbol: # 自己赢了
                    self.estimations[hash_val] = 1.0
                elif state.winner == 0: # 和棋
