# https://github.com/hkxIron/tensorflow_cookbook/blob/master/04_Support_Vector_Machines/02_Working_with_Linear_SVMs/02_linear_svm.py
...
# 不用SMO的svm,只是当决策平面分开,并没有找到到两类距离最大的决策面
# Declare optimizer
