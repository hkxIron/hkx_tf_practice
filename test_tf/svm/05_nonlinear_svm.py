# https://github.com/hkxIron/tensorflow_cookbook/tree/master/04_Support_Vector_Machines/05_Implementing_Nonlinear_SVMs
...
sq_dists = 2.*tf.matmul(x_data, tf.transpose(x_data))
...
cross_term = tf.reduce_sum(my_kernel*b_vec_cross*y_target_cross)
