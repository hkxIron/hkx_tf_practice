# blog:https://zhuanlan.zhihu.com/p/32801792
# 本教学代码中的predict的确可以run起来
...
tf.app.flags.DEFINE_integer('embedding_size', 100, '1024, Embedding dimensions of encoder and decoder inputs')
...
with tf.Session() as sess:
    ...
    for e in range(FLAGS.numEpochs):
        ...
        batches = getAllTrainBatches(trainingSamples, FLAGS.batch_size)
