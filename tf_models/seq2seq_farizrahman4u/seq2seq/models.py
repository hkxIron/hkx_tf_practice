...
def AttentionSeq2Seq(output_dim, output_length, batch_input_shape=None,
    ...
    encoder.add(LSTMCell(hidden_dim, batch_input_shape=(shape[0], shape[2]))) # shape[0]:batch, shape[2]:input_dim
    ...
    if bidirectional:
        ...
        encoder.forward_layer.build(shape) # [batch, max_encoder_length, input_dim]
