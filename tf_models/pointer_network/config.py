...
misc_arg.add_argument('--train_data_dir', type=str, default='D:\\dataset\\pointer_network_data\\tsp10_train.txt')
misc_arg.add_argument('--test_data_dir', type=str, default='D:\\dataset\\pointer_network_data\\tsp10_test.txt')
