...
net_arg.add_argument('--input_dim', type=int, default=2, help='x,y')
...
data_arg.add_argument('--batch_size', type=int, default=20) # 128
...
train_arg.add_argument('--lr_decay_step', type=int, default=1000, help='')
train_arg.add_argument('--lr_decay_rate', type=float, default=0.99, help='')
...
misc_arg.add_argument('--train_data_dir', type=str, default='data/tsp10_train.txt')
misc_arg.add_argument('--test_data_dir', type=str, default='data/tsp10_test.txt')
